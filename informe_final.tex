...
\begin{center}
  \vspace{-0.8cm}
  {\LARGE\bfseries Clasificación Automática de Calidad de Frutas} \\
  \vspace{0.2cm}
  {\large Mediante Visión por Computadora y Aprendizaje Automático} \\
  \vspace{0.3cm}
  {\small
    Nicolás \textsc{Jiménez}, Juan David \textsc{Rosero} \\
    \textsc{Universidad ICESI} --- Facultad de Ingeniería, Diseño y Ciencias Aplicadas \\
    Programa de Ingeniería de Sistemas --- APO III, Semestre 2026-1 \\
    \href{mailto:nicolas.jimenez@ejemplo.com}{nicolas.jimenez@ejemplo.com} \\
    \href{mailto:juan.rosero@ejemplo.com}{juan.rosero@ejemplo.com}
  }
  \vspace{0.3cm}
\end{center}
}]
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fig_distribucion.pdf}
...
La CNN implementada consta de: entrada (64\texttimes64\texttimes3), Conv2D(32, 3\texttimes3) + BatchNorm + ReLU + MaxPool(2\texttimes2), Conv2D(64, 3\texttimes3) + BatchNorm + ReLU + MaxPool(2\texttimes2), Conv2D(128, 3\texttimes3) + BatchNorm + ReLU + MaxPool(2\texttimes2), Dropout(0.5), Dense(256, ReLU), Dropout(0.3) y Dense(3, Softmax).
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fig_matriz_confusion_rf.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fig_metricas_clase_rf.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fig_roc_rf.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fig_importancia_rf.pdf}
